...
// 1ª Carta
    ...
    float SuperPoder =  População + Área + PIB + Pontos + PIBPerCapita; // Super poder da primeira carta.
...
// 2ª Carta
    ...
    float SuperPoder2 = População2 + Área2 + PIB2 + Pontos2 + PIBPerCapita2; // Super poder da segunda carta.
    ...
    printf("População: %lu\n", População); // Exibe a população. (função %lu para formatar unsigned long int).
